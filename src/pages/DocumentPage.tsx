...
export function DocumentPage() {
  ...
  const headings = useMemo(
    () => (project && file ? extractHeadingsForToc(file.content, project.config) : []),
    [file, project],
  )

  const { activeSlug: scrollActiveSlug, setActiveSlug: setScrollActiveSlug } = useHeadingScrollSpy(
    headings,
    isProgrammaticScrollRef,
  )
  useScrollToHeading(setScrollActiveSlug, isProgrammaticScrollRef)

...
```timeline
- [2027.01] Epidemia w Europie
- [2027.02] Projekt BLACKMOTH
- [2027.03] Izolacja Ameryki
	- Obrony Hemisferyczna — zajęcie Kanady i Kanału Panamskiego przez US Army i Navy
	- Rozkaz strzelania do cywilnych statków i samolotów bez autoryzacji. Media objęte cenzurą.
- [2027.04] Operacja IRON CURTAIN — zamknięcie granicy z Meksykiem. Kartele rozpoczynają wojnę z USA
- [2027.05] Kryzys eksploduje — trzy uderzenia w ciągu jednego miesiąca
	- Alfa ucieka z laboratorium DeathNet'u
	- Alfa przekracza Kanał Panamski i uderza na tyły oddziałów USA
- [2027.06] Operacja HAMMERBLOW — kontratak dywizji pancernej USA odpychająca kartele. Panama przechodzi w łapy zombie.
- [2027.08] Alfa pojawia się w Miami — mutacja wodna, zarażeni zdolni do długiego zanurzenia.
- [2027.09] Upadek Atlanty — Hartsfield-Jackson jako pułapka dla 200k ewakuujących. Logistyka całego Południa przecięta.
...
- [2028.03] Operacja SCORCHED LINE — nuklearny atak na południe
	...
	- Alfa przeżywa w tunelu metra. Alfa (Kolumbia) była już po północnej stronie Kanału.
- [2028.05] Upadek San Antonio — Alfa uderza czterostronnie na Fort Sam Houston i Lackland AFB. Utrata zaplecza militarnego Południa.
- [2028.06] Operacja CROWN FALL — rząd ewakuuje się do Raven Rock (PA). Ostatni żołnierz opuszcza Pentagon 4 lipca.
- [2028.07] Pierwsza współpraca osobników Alfa — NSA rejestruje skoordynowane ataki na 6 miast w 18 godzin.
...
## Chronologia upadku miast

| Miasto | Status | Data |
|---|---|---|
| Boston | UPADŁO | 2027.05 |
| Atlanta | UPADŁO | 2027.09 |
| Miami | UPADŁO | 2027.10 |
| Houston | UPADŁO | 2027.11 | 
| New York City | UPADŁO | 2028.01 |
| Chicago | UPADŁO | 2028.02 |
| San Antonio | UPADŁO | 2028.05 |
| Washington D.C. | EWAKUOWANE |
| Los Angeles | UPADŁO | 2028.09 |
| San Francisco | UPADŁO | 2029.05 |
| Las Vegas | UPADŁO | 2029.06 |
...
`ToDo: Walka o miasta USA`

`ToDo: Uderzenie jądrowe USA na Meksyk i Panamę`

`ToDo: Rekonkwista Phantomów`

`ToDo: Wojna z Alpha'mi`
...
`ToDo: Tułaczka i eksploatacje pozostałości przez ludzi`

`ToDo: Plemiona`

`ToDo: Pierwsze małe osady`
...
> [!lore]
> Każda postać może spokojnie wyglądać na kilka lat młodszą lub starszą z uwagi na to co przeszła lub zmiany genetyczne, których doświadczyła. Należy też pamiętać, że niektórzy ludzie mogą żyć krócej lub dłużej z tych samych względów.
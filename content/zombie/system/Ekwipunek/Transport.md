...
| Motocykl | 3 | @pros:Szybki(3) @pros:Manewrowość @cons:Spalanie @cons:Mały-ładowność(2) | Szybki transport dla jednej lub dwóch osób. Wymaga benzyny i podstawowej wiedzy mechanicznej. |
| Samochód spalinowy | 4 | @pros:Szybki(2) @pros:Ładowność(2) @pros:Wytrzymały(2) @cons:Spalanie(2) @cons:Głośny(2) | Osobowy lub dostawczy na benzynie/oleju. Szybki transport grupy i ekwipunku — wymaga paliwa i przejezdnych dróg. |
...
| Ciężarówka | 4 | @pros:Ładowność(4) @pros:Wytrzymały(2) @cons:Spalanie(3) @cons:Głośny(3) @cons:Ciężki | Średni lub ciężki pojazd użytkowy. Duża ładowność przy umiarkowanej manewrowości — paliwożerna i głośna. |
| Tir | 5 | @pros:Ładowność(5) @pros:Wytrzymały(3) @cons:Spalanie(4) @cons:Głośny(3) @cons:Ciężki(2) | Ciężarówka dalekobieżna z naczepą. Ogromna ładowność, trudna w manewrach i żarłoczna na paliwo. Przyciąga uwagę. |

...
| Plandeka | 2 | @pros:Lekki(1) | Lekka płachta do budowy prowizorycznego schronienia lub ochrony przed deszczem. |
| Śpiwór | 2 | - | Ochrona przed zimnem przy nocowaniu w terenie. |
| Lina (10 m) | 2 | - | Nylonowa lub sizalowa. Wspinaczka, pułapki, schronienia — jedno z najbardziej wielozadaniowych narzędzi przetrwania. |
...
| Zestaw chirurgiczny | 4 | @pros:Antyseptyczny(4) | Komplet sterylnych lub możliwych do wysterylizowania narzędzi pozwalających na profesjonalne opracowanie ran. |
...
| Wrzątek | 1 | @pros:Antyseptyczny(1) | Gorąca woda przydatna przede wszystkim do oczyszczania ran oraz wyjaławiania narzędzi i materiałów. |
| Chlorheksydyna | 5 | @pros:Antyseptyczny(5) | Silny i szeroko działający antyseptyk, skuteczny przeciwko wielu bakteriom i innym drobnoustrojom. |
...
| Smar | 2 | @pros:Konserwujący(1) | Olej lub odpowiednik WD-40. Do konserwacji broni, narzędzi i ruchomych części mechanizmów. Zapobiega rdzy. |
| Piła ręczna | 2 | - | Do cięcia drewna. Powolna, ale bezgłośna i niezawodna. |
| Młotek | 2 | - | Do wbijania gwoździ, wyważania i podstawowych prac ciesielskich. |

## Materiały

| Nazwa | Wartość | Właściwości | Opis |
|---|:---:|---|---|
| Gwoździe i śruby | 1 | - | Metalowe elementy łączące. Zbierać ze zrujnowanych budynków. |
| Deski i drewno | 1 | - | Podstawowy materiał budowlany. Dostępny wszędzie tam, gdzie były ludzkie osady. |
| Blacha | 2 | - | Do wzmacniania schronień, prowizorycznych wzmocnień pancerzy i improwizowanych narzędzi. |
| Plastikowe pojemniki | 1 | - | Butelki, baniaki, skrzynie. Do przechowywania wody, żywności i drobnego wyposażenia. |

## Elektryka i komunikacja

| Nazwa | Wartość | Właściwości | Opis |
|---|:---:|---|---|
| Panele słoneczne | 4 | @pros:Odnawialny(2) @cons:Zależny-od-pogody(2) | Konwertują światło słoneczne na prąd. Do ładowania akumulatorów i zasilania prostych urządzeń. |
| Akumulator | 3 | @cons:Ciężki(2) | Magazyn energii elektrycznej. Do zasilania urządzeń gdy nie ma innego źródła prądu. |
| Radio korbowe | 3 | @pros:Niezależny(1) | Odbiornik na baterie lub korbkę. Dostęp do informacji bez zewnętrznego zasilania. |
| Przewody elektryczne | 2 | - | Miedziane lub aluminiowe kable. Do rozprowadzania prądu i napraw instalacji. |

## Transport

`ToDo: pojazdy i transport zasługują na osobny plik — poniżej tylko podstawowe pozycje`

| Nazwa | Wartość | Właściwości | Opis |
|---|:---:|---|---|
| Rower | 2 | @pros:Niezależny(2) @pros:Cichy(1) | Transport bez paliwa i hałasu. Wytrzymały i łatwy w naprawie. Ograniczona ładowność. |
| Motocykl | 3 | @pros:Szybki(2) @cons:Paliwożerny(2) | Szybki transport dla jednej lub dwóch osób. Wymaga benzyny i podstawowej wiedzy mechanicznej. |
| Kanister na paliwo | 3 | @cons:Łatwopalny(2) | Pojemnik do magazynowania benzyny lub oleju. Zwiększa zasięg pojazdów, ale jest niebezpieczny przy pożarze. |
